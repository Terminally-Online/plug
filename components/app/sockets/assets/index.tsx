...
export const SocketAssets: FC<HTMLAttributes<HTMLDivElement> & { id: string }> = ({ id, ...props }) => {
	...
	return (
		<div {...props}>
			...
			<Header
				...
				icon={<CircleDollarSign size={14} className="opacity-40" />}
				label="Positions"
				nextLabel={positions.protocols.length < 3 ? undefined : positionsExpanded ? "Collapse" : "See All"}
