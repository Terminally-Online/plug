...
export const SocketEarnings: FC<HTMLAttributes<HTMLDivElement> & { id: string }> = ({ id, ...props }) => {
	...
	return (
		<div {...props}>
			...
			{plugs && (
				<>
					<Header size="md" icon={<Trophy size={14} className="opacity-40" />} label="Top Performers" />
