...
export const ReferralRequired: FC = () => {
  ...
  return (
    <div className="flex h-full w-full items-start justify-between flex-col bg-white">
      <div className="w-full flex justify-center pt-[30vh]">
      ...
      <div className="w-full flex justify-center pb-8">
        <div className="flex max-w-md w-full flex-col gap-2 px-4">
          <p className="text-center text-sm font-medium opacity-60">
