...
const variants: Record<NonNullable<Props["variant"]>, string> = {
	...
	secondary:
		"border-[1px] border-plug-green/10 text-black hover:border-white hover:bg-plug-green/10 items-center flex justify-center text-opacity-60 whitespace-nowrap [&.active]:bg-plug-green/5 [&.active]:text-opacity-100 [&.active]:hover:bg-plug-green/10 [&.active]:hover:border-plug-green/5",
