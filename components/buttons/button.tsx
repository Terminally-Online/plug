...
const variants: Record<NonNullable<Props["variant"]>, string> = {
	// add shadow of same gradient to primary
	primary:
	...
	secondary:
		"border-[1px] border-grayscale-100 text-black hover:bg-grayscale-100 hover:text-black/80 min-w-7 min-h-7 items-center flex justify-center opacity-60 hover:opacity-100 whitespace-nowrap bg-white",
