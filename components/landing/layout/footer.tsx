	...
	<>
		<LandingContainer className="mb-16 mt-24 flex-col gap-2 lg:gap-4">
			...
			<div className="grid grid-cols-1 font-bold text-black/40 lg:grid-cols-12">
				...
				<div className="mb-2 flex flex-col gap-2 lg:col-span-2">
					...
					<a href={routes.github} className="transition-opacity duration-200 hover:opacity-100">
						Code
					</a>
					<a href={routes.comingSoon} className="transition-opacity duration-200 hover:opacity-100">
						Audits
				...
				<div className="mb-2 flex flex-col gap-2 lg:col-span-2">
					<a href={routes.documentation} className="transition-opacity duration-200 hover:opacity-100">
						Documentation
					</a>
					<a href={routes.comingSoon} className="transition-opacity duration-200 hover:opacity-100">
						Guides
		...
		<div className="border-t-[1px] border-grayscale-100">
			<LandingContainer className="flex flex-col gap-2 py-4 font-bold text-black/40 lg:flex-row lg:gap-8">
				...
				<Link href="/coming-soon/" className="transition-opacity duration-200 hover:opacity-100 lg:ml-auto">
					Terms of Service
				</Link>
				<Link href="/coming-soon/" className="transition-opacity duration-200 hover:opacity-100">
					Privacy Policy
				</Link>
			</LandingContainer>
		</div>
