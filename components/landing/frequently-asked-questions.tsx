...
export const FrequentlyAskedQuestions: FC = () => (
	<LandingContainer>
		<div className="my-[90px] grid lg:grid-cols-12">
			...
			<div className="mt-[30px] flex flex-col gap-8 lg:col-span-5 lg:col-start-7">
