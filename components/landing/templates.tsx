	...
	return (
		<LandingContainer className="my-[90px] flex-col items-center gap-4">
			...
			<p className="text-center text-[18px] font-bold opacity-20 lg:max-w-[720px] lg:text-[24px]">
				In just a few minutes, you can deploy a strategy that has been battle-tested by the Plug team and
				industry experts, the opportunities are waiting for you.
			</p>
