...
const ExecutionAction: FC<PropsWithChildren<{ index: number; indexes: number; protocol: string }>> = ({
	...
	return (
		...
		>
			<motion.div
				className="bg-gradient-radial absolute inset-0 rounded-lg from-plug-green via-plug-yellow to-transparent opacity-0 blur-lg filter"
				initial={{ opacity: 0, rotate: 0 }}
				animate={{
					opacity: [0, 0.1, 0.2, 0],
					background: [
						"radial-gradient(circle at 0% 0%, #00E100 0%, #A3F700 50%, transparent 100%)",
						"radial-gradient(circle at 100% 0%, #00E100 0%, #A3F700 50%, transparent 100%)",
						"radial-gradient(circle at 100% 100%, #00E100 0%, #A3F700 50%, transparent 100%)",
						"radial-gradient(circle at 0% 100%, #00E100 0%, #A3F700 50%, transparent 100%)",
						"radial-gradient(circle at 0% 0%, #00E100 0%, #A3F700 50%, transparent 100%)"
					]
				}}
				transition={{
			...
			<motion.div
				className="bg-gradient-radial absolute inset-0 rounded-lg from-plug-green via-plug-yellow to-transparent opacity-0"
				initial={{ opacity: 0, rotate: 0 }}
				animate={{
					opacity: [0, 1, 1, 0],
					background: [
