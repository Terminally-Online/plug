...
export const Mitigation: FC = () => {
	...
	useEffect(() => {
		const controls = animate(patch, [40, 31, 38, 22, 30, 26, 32, 16, 10, 40, 60, 80, 90, 100], {
			duration: 4,
			delay: 1,
			repeat: Infinity,
			repeatDelay: 2,
	...
	return (
		<>
			...
			<svg viewBox="0 0 535 201" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[100%]">
				<motion.path
