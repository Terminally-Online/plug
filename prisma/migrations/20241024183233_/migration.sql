/*
  ...
  - Added the required column `nextSimulationAt` to the `QueuedWorkflow` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "nextSimulationAt" TIMESTAMP(3) NOT NULL,
