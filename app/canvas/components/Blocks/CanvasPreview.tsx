...
export const CanvasPreview: FC<CanvasPreviewProps> = ({ canvas }) => { 
  ...
  return <Link href={href} className="p-4 flex flex-row items-end border-[1px] border-stone-950 text-white hover:bg-white hover:text-stone-950 transition-all duration-200 ease-in-out">
    <div className="flex flex-col">
      <h1 className="text-lg font-bold">{name}</h1>
      <p className="text-sm opacity-60">Edited {durationInMinutes} minutes ago</p>
    </div>
  </Link>
}
