...
export const Block: FC<BlockProps> = ({ vertical }) => { 
  ...
  return <div className={cn("w-full flex", vertical ? 'h-full flex-col' : 'flex-row')}>
    <button 
    ...
    >
      ...
      <p className="opacity-60 max-w-[180px]">Start from scratch and build out your own approach.</p>
    </button>
