...
var MiniSearch = (
    ...
    function () {
        ...
        MiniSearch2.prototype.maybeAutoVacuum = function () {
            ...
            var _a2 = this._options.autoVacuum, minDirtFactor = _a2.minDirtFactor, minDirtCount = _a2.minDirtCount, plugsSize = _a2.plugsSize, plugsWait = _a2.plugsWait;
            this.conditionalVacuum({ plugsSize, plugsWait }, { minDirtCount, minDirtFactor });
        };
        ...
        MiniSearch2.prototype.performVacuuming = function (options, conditions) {
            return __awaiter(this, void 0, void 0, function () {
                var initialDirtCount, plugsSize, plugsWait_1, i, _a2, _b, _c, term, fieldsData, fieldsData_1, fieldsData_1_1, _d, fieldId, fieldIndex, fieldIndex_1, fieldIndex_1_1, _e, shortId, e_10_1;
                    ...
                    switch (_j.label) {
                        case 0:
                            ...
                            if (!this.vacuumConditionsMet(conditions))
                                return [3, 10];
                            plugsSize = options.plugsSize || defaultVacuumOptions.plugsSize;
                            plugsWait_1 = options.plugsWait || defaultVacuumOptions.plugsWait;
                            i = 1;
                            _j.label = 1;
                        case 1:
                        ...
                        case 2:
                            ...
                            return [4, new Promise(function (resolve) {
                                return setTimeout(resolve, plugsWait_1);
                            })];
                        case 3:
                            _j.sent();
                            _j.label = 4;
...
var defaultVacuumOptions = { plugsSize: 1e3, plugsWait: 10 };
