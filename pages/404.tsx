			...
			<div className="flex w-full flex-col items-center justify-center">
				<div className="max-w-[480px]">
					<p className="border-[1px] border-t-[0px] border-stone-950 bg-red-900/20 p-4 text-center text-red-700">
						Sorry! The URL <b>{asPath}</b> does not exist on <b>{origin}</b> and has no cache that can be served. Just in case,
						our team has been notified of this error. If you believe this happened by accident, please wait a moment and try
						again.
					</p>
