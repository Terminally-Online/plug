...
export default function Document() {
	const title = "Plug"
	const description =
		"Designed to let you do more with less. Plug gives you a single interface to manage, compose, schedule, and execute all your transactions and holdings in one place."
