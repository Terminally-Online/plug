...
// MAXTIMEBUFFER is a free data retrieval call binding the contract method 0x85317a29.
//
// Solidity: function MAX_TIME_BUFFER() view returns(uint56)
func (_NounsAuctionHouse *NounsAuctionHouseCaller) MAXTIMEBUFFER(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _NounsAuctionHouse.contract.Call(opts, &out, "MAX_TIME_BUFFER")
...
//
// Solidity: function MAX_TIME_BUFFER() view returns(uint56)
func (_NounsAuctionHouse *NounsAuctionHouseSession) MAXTIMEBUFFER() (*big.Int, error) {
	return _NounsAuctionHouse.Contract.MAXTIMEBUFFER(&_NounsAuctionHouse.CallOpts)
}

// MAXTIMEBUFFER is a free data retrieval call binding the contract method 0x85317a29.
//
// Solidity: function MAX_TIME_BUFFER() view returns(uint56)
func (_NounsAuctionHouse *NounsAuctionHouseCallerSession) MAXTIMEBUFFER() (*big.Int, error) {
	return _NounsAuctionHouse.Contract.MAXTIMEBUFFER(&_NounsAuctionHouse.CallOpts)
}
...
// AuctionStorage is a free data retrieval call binding the contract method 0x945c37cb.
//
// Solidity: function auctionStorage() view returns(uint96 nounId, uint32 clientId, uint128 amount, uint40 startTime, uint40 endTime, address bidder, bool settled)
func (_NounsAuctionHouse *NounsAuctionHouseCaller) AuctionStorage(opts *bind.CallOpts) (struct {
	NounId    *big.Int
	ClientId  uint32
	Amount    *big.Int
	StartTime *big.Int
	...
	var out []interface{}
	err := _NounsAuctionHouse.contract.Call(opts, &out, "auctionStorage")
	...
	outstruct.ClientId = *abi.ConvertType(out[1], new(uint32)).(*uint32)
...
//
// Solidity: function auctionStorage() view returns(uint96 nounId, uint32 clientId, uint128 amount, uint40 startTime, uint40 endTime, address bidder, bool settled)
func (_NounsAuctionHouse *NounsAuctionHouseSession) AuctionStorage() (struct {
	NounId    *big.Int
	ClientId  uint32
	Amount    *big.Int
	StartTime *big.Int
	...
	return _NounsAuctionHouse.Contract.AuctionStorage(&_NounsAuctionHouse.CallOpts)
}

// AuctionStorage is a free data retrieval call binding the contract method 0x945c37cb.
//
// Solidity: function auctionStorage() view returns(uint96 nounId, uint32 clientId, uint128 amount, uint40 startTime, uint40 endTime, address bidder, bool settled)
func (_NounsAuctionHouse *NounsAuctionHouseCallerSession) AuctionStorage() (struct {
	NounId    *big.Int
	ClientId  uint32
	Amount    *big.Int
	StartTime *big.Int
...
// BiddingClient is a free data retrieval call binding the contract method 0x6dd83b5d.
//
// Solidity: function biddingClient(uint256 nounId) view returns(uint32)
func (_NounsAuctionHouse *NounsAuctionHouseCaller) BiddingClient(opts *bind.CallOpts, nounId *big.Int) (uint32, error) {
	var out []interface{}
	err := _NounsAuctionHouse.contract.Call(opts, &out, "biddingClient", nounId)
...
//
// Solidity: function biddingClient(uint256 nounId) view returns(uint32)
func (_NounsAuctionHouse *NounsAuctionHouseSession) BiddingClient(nounId *big.Int) (uint32, error) {
	return _NounsAuctionHouse.Contract.BiddingClient(&_NounsAuctionHouse.CallOpts, nounId)
}

// BiddingClient is a free data retrieval call binding the contract method 0x6dd83b5d.
//
// Solidity: function biddingClient(uint256 nounId) view returns(uint32)
func (_NounsAuctionHouse *NounsAuctionHouseCallerSession) BiddingClient(nounId *big.Int) (uint32, error) {
	return _NounsAuctionHouse.Contract.BiddingClient(&_NounsAuctionHouse.CallOpts, nounId)
}
...
// GetPrices is a free data retrieval call binding the contract method 0x91492956.
//
// Solidity: function getPrices(uint256 auctionCount) view returns(uint256[] prices)
func (_NounsAuctionHouse *NounsAuctionHouseCaller) GetPrices(opts *bind.CallOpts, auctionCount *big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _NounsAuctionHouse.contract.Call(opts, &out, "getPrices", auctionCount)
...
//
// Solidity: function getPrices(uint256 auctionCount) view returns(uint256[] prices)
func (_NounsAuctionHouse *NounsAuctionHouseSession) GetPrices(auctionCount *big.Int) ([]*big.Int, error) {
	return _NounsAuctionHouse.Contract.GetPrices(&_NounsAuctionHouse.CallOpts, auctionCount)
}

// GetPrices is a free data retrieval call binding the contract method 0x91492956.
//
// Solidity: function getPrices(uint256 auctionCount) view returns(uint256[] prices)
func (_NounsAuctionHouse *NounsAuctionHouseCallerSession) GetPrices(auctionCount *big.Int) ([]*big.Int, error) {
	return _NounsAuctionHouse.Contract.GetPrices(&_NounsAuctionHouse.CallOpts, auctionCount)
}
...
//
// Solidity: function reservePrice() view returns(uint192)
...
// CreateBid0 is a paid mutator transaction binding the contract method 0xabbfb786.
//
// Solidity: function createBid(uint256 nounId, uint32 clientId) payable returns()
func (_NounsAuctionHouse *NounsAuctionHouseTransactor) CreateBid0(opts *bind.TransactOpts, nounId *big.Int, clientId uint32) (*types.Transaction, error) {
	return _NounsAuctionHouse.contract.Transact(opts, "createBid0", nounId, clientId)
}

// CreateBid0 is a paid mutator transaction binding the contract method 0xabbfb786.
//
// Solidity: function createBid(uint256 nounId, uint32 clientId) payable returns()
func (_NounsAuctionHouse *NounsAuctionHouseSession) CreateBid0(nounId *big.Int, clientId uint32) (*types.Transaction, error) {
...
//
// Solidity: function createBid(uint256 nounId, uint32 clientId) payable returns()
func (_NounsAuctionHouse *NounsAuctionHouseTransactorSession) CreateBid0(nounId *big.Int, clientId uint32) (*types.Transaction, error) {
	return _NounsAuctionHouse.Contract.CreateBid0(&_NounsAuctionHouse.TransactOpts, nounId, clientId)
}
...
// SetReservePrice is a paid mutator transaction binding the contract method 0xc0555d98.
//
...
//
// Solidity: function setTimeBuffer(uint56 _timeBuffer) returns()
...
// WarmUpSettlementState is a paid mutator transaction binding the contract method 0x5112fabf.
//
// Solidity: function warmUpSettlementState(uint256 startId, uint256 endId) returns()
func (_NounsAuctionHouse *NounsAuctionHouseTransactor) WarmUpSettlementState(opts *bind.TransactOpts, startId *big.Int, endId *big.Int) (*types.Transaction, error) {
	return _NounsAuctionHouse.contract.Transact(opts, "warmUpSettlementState", startId, endId)
}

// WarmUpSettlementState is a paid mutator transaction binding the contract method 0x5112fabf.
//
// Solidity: function warmUpSettlementState(uint256 startId, uint256 endId) returns()
func (_NounsAuctionHouse *NounsAuctionHouseSession) WarmUpSettlementState(startId *big.Int, endId *big.Int) (*types.Transaction, error) {
	return _NounsAuctionHouse.Contract.WarmUpSettlementState(&_NounsAuctionHouse.TransactOpts, startId, endId)
}

// WarmUpSettlementState is a paid mutator transaction binding the contract method 0x5112fabf.
//
// Solidity: function warmUpSettlementState(uint256 startId, uint256 endId) returns()
func (_NounsAuctionHouse *NounsAuctionHouseTransactorSession) WarmUpSettlementState(startId *big.Int, endId *big.Int) (*types.Transaction, error) {
	return _NounsAuctionHouse.Contract.WarmUpSettlementState(&_NounsAuctionHouse.TransactOpts, startId, endId)
}
...
// NounsAuctionHouseAuctionBidWithClientIdIterator is returned from FilterAuctionBidWithClientId and is used to iterate over the raw logs and unpacked data for AuctionBidWithClientId events raised by the NounsAuctionHouse contract.
type NounsAuctionHouseAuctionBidWithClientIdIterator struct {
	Event *NounsAuctionHouseAuctionBidWithClientId // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NounsAuctionHouseAuctionBidWithClientIdIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(NounsAuctionHouseAuctionBidWithClientId)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NounsAuctionHouseAuctionBidWithClientIdIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NounsAuctionHouseAuctionBidWithClientIdIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NounsAuctionHouseAuctionBidWithClientId represents a AuctionBidWithClientId event raised by the NounsAuctionHouse contract.
type NounsAuctionHouseAuctionBidWithClientId struct {
	NounId   *big.Int
	Value    *big.Int
	ClientId uint32
	Raw      types.Log // Blockchain specific contextual infos
...
// FilterAuctionBidWithClientId is a free log retrieval operation binding the contract event 0x38e150a71033b4c9a3eeb9ebe568476f075a558e47171f3b5d715aa0cf6cd1b5.
//
// Solidity: event AuctionBidWithClientId(uint256 indexed nounId, uint256 value, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) FilterAuctionBidWithClientId(opts *bind.FilterOpts, nounId []*big.Int, clientId []uint32) (*NounsAuctionHouseAuctionBidWithClientIdIterator, error) {
	...
	logs, sub, err := _NounsAuctionHouse.contract.FilterLogs(opts, "AuctionBidWithClientId", nounIdRule, clientIdRule)
	if err != nil {
		return nil, err
	}
	return &NounsAuctionHouseAuctionBidWithClientIdIterator{contract: _NounsAuctionHouse.contract, event: "AuctionBidWithClientId", logs: logs, sub: sub}, nil
}

// WatchAuctionBidWithClientId is a free log subscription operation binding the contract event 0x38e150a71033b4c9a3eeb9ebe568476f075a558e47171f3b5d715aa0cf6cd1b5.
//
// Solidity: event AuctionBidWithClientId(uint256 indexed nounId, uint256 value, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) WatchAuctionBidWithClientId(opts *bind.WatchOpts, sink chan<- *NounsAuctionHouseAuctionBidWithClientId, nounId []*big.Int, clientId []uint32) (event.Subscription, error) {
	...
	logs, sub, err := _NounsAuctionHouse.contract.WatchLogs(opts, "AuctionBidWithClientId", nounIdRule, clientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NounsAuctionHouseAuctionBidWithClientId)
				if err := _NounsAuctionHouse.contract.UnpackLog(event, "AuctionBidWithClientId", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAuctionBidWithClientId is a log parse operation binding the contract event 0x38e150a71033b4c9a3eeb9ebe568476f075a558e47171f3b5d715aa0cf6cd1b5.
//
// Solidity: event AuctionBidWithClientId(uint256 indexed nounId, uint256 value, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) ParseAuctionBidWithClientId(log types.Log) (*NounsAuctionHouseAuctionBidWithClientId, error) {
	event := new(NounsAuctionHouseAuctionBidWithClientId)
	if err := _NounsAuctionHouse.contract.UnpackLog(event, "AuctionBidWithClientId", log); err != nil {
		return nil, err
	}
...
// NounsAuctionHouseAuctionSettledWithClientIdIterator is returned from FilterAuctionSettledWithClientId and is used to iterate over the raw logs and unpacked data for AuctionSettledWithClientId events raised by the NounsAuctionHouse contract.
type NounsAuctionHouseAuctionSettledWithClientIdIterator struct {
	Event *NounsAuctionHouseAuctionSettledWithClientId // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NounsAuctionHouseAuctionSettledWithClientIdIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(NounsAuctionHouseAuctionSettledWithClientId)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NounsAuctionHouseAuctionSettledWithClientIdIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NounsAuctionHouseAuctionSettledWithClientIdIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NounsAuctionHouseAuctionSettledWithClientId represents a AuctionSettledWithClientId event raised by the NounsAuctionHouse contract.
type NounsAuctionHouseAuctionSettledWithClientId struct {
	NounId   *big.Int
	ClientId uint32
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterAuctionSettledWithClientId is a free log retrieval operation binding the contract event 0xf445afb110f5e782fc78bf23e7066d3c5a95f7b57bd25fb718a29ad0287db2b9.
//
// Solidity: event AuctionSettledWithClientId(uint256 indexed nounId, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) FilterAuctionSettledWithClientId(opts *bind.FilterOpts, nounId []*big.Int, clientId []uint32) (*NounsAuctionHouseAuctionSettledWithClientIdIterator, error) {
	...
	logs, sub, err := _NounsAuctionHouse.contract.FilterLogs(opts, "AuctionSettledWithClientId", nounIdRule, clientIdRule)
	if err != nil {
		return nil, err
	}
	return &NounsAuctionHouseAuctionSettledWithClientIdIterator{contract: _NounsAuctionHouse.contract, event: "AuctionSettledWithClientId", logs: logs, sub: sub}, nil
}

// WatchAuctionSettledWithClientId is a free log subscription operation binding the contract event 0xf445afb110f5e782fc78bf23e7066d3c5a95f7b57bd25fb718a29ad0287db2b9.
//
// Solidity: event AuctionSettledWithClientId(uint256 indexed nounId, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) WatchAuctionSettledWithClientId(opts *bind.WatchOpts, sink chan<- *NounsAuctionHouseAuctionSettledWithClientId, nounId []*big.Int, clientId []uint32) (event.Subscription, error) {
	...
	logs, sub, err := _NounsAuctionHouse.contract.WatchLogs(opts, "AuctionSettledWithClientId", nounIdRule, clientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NounsAuctionHouseAuctionSettledWithClientId)
				if err := _NounsAuctionHouse.contract.UnpackLog(event, "AuctionSettledWithClientId", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAuctionSettledWithClientId is a log parse operation binding the contract event 0xf445afb110f5e782fc78bf23e7066d3c5a95f7b57bd25fb718a29ad0287db2b9.
//
// Solidity: event AuctionSettledWithClientId(uint256 indexed nounId, uint32 indexed clientId)
func (_NounsAuctionHouse *NounsAuctionHouseFilterer) ParseAuctionSettledWithClientId(log types.Log) (*NounsAuctionHouseAuctionSettledWithClientId, error) {
	event := new(NounsAuctionHouseAuctionSettledWithClientId)
	if err := _NounsAuctionHouse.contract.UnpackLog(event, "AuctionSettledWithClientId", log); err != nil {
		return nil, err
	}
