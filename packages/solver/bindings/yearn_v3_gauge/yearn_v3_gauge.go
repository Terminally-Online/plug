...
//
// Solidity: function deposit(uint256 _assets, address _receiver) returns(uint256 assets)
...
//
// Solidity: function redeem(uint256 _assets, address _receiver, address _owner) returns(uint256 shares)
