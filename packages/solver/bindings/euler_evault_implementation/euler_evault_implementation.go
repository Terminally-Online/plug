...
//
// Solidity: function borrow(uint256 amount, address receiver) returns(uint256 assets)
...
//
// Solidity: function deposit(uint256 amount, address receiver) returns(uint256 shares)
...
//
// Solidity: function repay(uint256 amount, address receiver) returns(uint256 assets)
...
//
// Solidity: function withdraw(uint256 amount, address receiver, address owner) returns(uint256 shares)
