...
// IsLegacyVault is a free data retrieval call binding the contract method 0xda1281dd.
//
// Solidity: function isLegacyVault(address _vault) view returns(bool)
func (_YearnV3Registry *YearnV3RegistryCaller) IsLegacyVault(opts *bind.CallOpts, _vault common.Address) (bool, error) {
	var out []interface{}
	err := _YearnV3Registry.contract.Call(opts, &out, "isLegacyVault", _vault)
...
//
// Solidity: function isLegacyVault(address _vault) view returns(bool)
func (_YearnV3Registry *YearnV3RegistrySession) IsLegacyVault(_vault common.Address) (bool, error) {
	return _YearnV3Registry.Contract.IsLegacyVault(&_YearnV3Registry.CallOpts, _vault)
}

// IsLegacyVault is a free data retrieval call binding the contract method 0xda1281dd.
//
// Solidity: function isLegacyVault(address _vault) view returns(bool)
func (_YearnV3Registry *YearnV3RegistryCallerSession) IsLegacyVault(_vault common.Address) (bool, error) {
	return _YearnV3Registry.Contract.IsLegacyVault(&_YearnV3Registry.CallOpts, _vault)
}

// LegacyRegistry is a free data retrieval call binding the contract method 0xae8c9d13.
//
// Solidity: function legacyRegistry() view returns(address)
func (_YearnV3Registry *YearnV3RegistryCaller) LegacyRegistry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _YearnV3Registry.contract.Call(opts, &out, "legacyRegistry")
...
//
// Solidity: function legacyRegistry() view returns(address)
func (_YearnV3Registry *YearnV3RegistrySession) LegacyRegistry() (common.Address, error) {
	return _YearnV3Registry.Contract.LegacyRegistry(&_YearnV3Registry.CallOpts)
}

// LegacyRegistry is a free data retrieval call binding the contract method 0xae8c9d13.
//
// Solidity: function legacyRegistry() view returns(address)
func (_YearnV3Registry *YearnV3RegistryCallerSession) LegacyRegistry() (common.Address, error) {
	return _YearnV3Registry.Contract.LegacyRegistry(&_YearnV3Registry.CallOpts)
}
...
// SetLegacyRegistry is a paid mutator transaction binding the contract method 0xa4fc5922.
//
// Solidity: function setLegacyRegistry(address _legacyRegistry) returns()
func (_YearnV3Registry *YearnV3RegistryTransactor) SetLegacyRegistry(opts *bind.TransactOpts, _legacyRegistry common.Address) (*types.Transaction, error) {
	return _YearnV3Registry.contract.Transact(opts, "setLegacyRegistry", _legacyRegistry)
}

// SetLegacyRegistry is a paid mutator transaction binding the contract method 0xa4fc5922.
//
// Solidity: function setLegacyRegistry(address _legacyRegistry) returns()
func (_YearnV3Registry *YearnV3RegistrySession) SetLegacyRegistry(_legacyRegistry common.Address) (*types.Transaction, error) {
	return _YearnV3Registry.Contract.SetLegacyRegistry(&_YearnV3Registry.TransactOpts, _legacyRegistry)
}

// SetLegacyRegistry is a paid mutator transaction binding the contract method 0xa4fc5922.
//
// Solidity: function setLegacyRegistry(address _legacyRegistry) returns()
func (_YearnV3Registry *YearnV3RegistryTransactorSession) SetLegacyRegistry(_legacyRegistry common.Address) (*types.Transaction, error) {
	return _YearnV3Registry.Contract.SetLegacyRegistry(&_YearnV3Registry.TransactOpts, _legacyRegistry)
}
