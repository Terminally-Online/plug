...
export const ScrollingError = ({ error, duration }: { error: string | undefined, duration?: number }) => {
	...
	return (
		<div className="relative min-h-6 overflow-x-hidden">
			...
			<Marquee duration={duration} className="-z-1 relative max-w-full whitespace-nowrap font-bold text-plug-red">{error}</Marquee>
		</div>
	)
}
