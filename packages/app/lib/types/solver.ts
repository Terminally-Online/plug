...
const SchemasResponseIconSchema = z.object({
  default: z.string(),
  secondary: z.string()
...
const SchemasRequestValueOptionExtensionSchema = z.object({
  label: z.string().optional(),
  icon: SchemasResponseIconSchema,
  info: SchemasResponseInfoSchema,
}).optional().and(SchemasRequestValueManualSchema);
...
const SchemasResponseOptionsSetSchema: z.ZodType<Record<string, z.infer<typeof SchemasResponseOptionsSchema> | Record<string, z.infer<typeof SchemasResponseOptionsSchema>>>> =
  z.record(z.string(), z.union([
    SchemasResponseOptionsSchema,
    z.record(z.string(), SchemasResponseOptionsSchema)
  ]));
...
const SolverResponseRunSchema = <TDecoded extends z.ZodTypeAny = z.ZodRecord<z.ZodString, z.ZodUnknown>>(decodedSchema: TDecoded = z.record(z.string(), z.unknown()) as unknown as TDecoded) => z.object({
  id: z.string(),
  status: z.string(),
...
export type SolverResponseRun<TDecoded extends Record<string, unknown> = Record<string, unknown>> =
  z.infer<ReturnType<typeof SolverResponseRunSchema<z.ZodType<TDecoded>>>>;

const IntentResponseIntentSchema = <TDecoded extends z.ZodTypeAny = z.ZodRecord<z.ZodString, z.ZodUnknown>>(decodedSchema: TDecoded = z.record(z.string(), z.unknown()) as unknown as TDecoded) => z.object({
  id: z.string(),
  status: z.string(),
  chainId: z.number(),
  from: z.string(),
...
export type IntentResponseIntent<TDecoded extends Record<string, unknown> = Record<string, unknown>> =
  z.infer<ReturnType<typeof IntentResponseIntentSchema<z.ZodType<TDecoded>>>>;
...
const SolutionResponseRunSchema = <TDecoded extends z.ZodTypeAny = z.ZodRecord<z.ZodString, z.ZodUnknown>>(decodedSchema: TDecoded = z.record(z.string(), z.unknown()) as unknown as TDecoded) => z.object({
  id: z.string(),
  status: z.string(),
...
export type SolutionResponseRun<TDecoded extends Record<string, unknown> = Record<string, unknown>> =
  z.infer<ReturnType<typeof SolutionResponseRunSchema<z.ZodType<TDecoded>>>>;

const IntentResponseSchema = <TDecoded extends z.ZodTypeAny = z.ZodRecord<z.ZodString, z.ZodUnknown>>(decodedSchema: TDecoded = z.record(z.string(), z.unknown()) as unknown as TDecoded) => z.object({
  transactions: z.array(SolutionResponseTransactionSchema),
  run: SolutionResponseRunSchema(decodedSchema).optional()
});
export type IntentResponse<TDecoded extends Record<string, unknown> = Record<string, unknown>> =
  z.infer<ReturnType<typeof IntentResponseSchema<z.ZodType<TDecoded>>>>;
