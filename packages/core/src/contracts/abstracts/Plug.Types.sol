...
library PlugTypesLib {
    ...
    /**
     * @notice This struct is used to encode Slice data into a hash and
     *         decode Slice data from a hash.
     *
     * @dev Slice extends EIP712<{
    ...
    /**
     * @notice This struct is used to encode Update data into a hash and
     *         decode Update data from a hash.
     *
     * @dev Update extends EIP712<{
     * 		{ name: 'start', type: 'uint256' }
...
abstract contract PlugTypes {
    ...
    function getUpdateHash(PlugTypesLib.Update memory $input)
        ...
        returns (bytes32 $typeHash)
    {
        $typeHash = keccak256(abi.encode(UPDATE_TYPEHASH, $input.start, getSliceHash($input.slice)));
    }
