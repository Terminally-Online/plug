...
contract PlugTest is Test {
    ...
    function test_PlugEmptyEcho() public {
        ...
        PlugTypesLib.LivePlugs[] memory livePlugsArray =
            new PlugTypesLib.LivePlugs[](1);
    ...
    function testRevert_PlugEmptyEchoWithSolverAndTreasuryPaymentFailure() public {
        address solver = _randomNonZeroAddress();
        vm.deal(solver, 100 ether);
    ...
    function test_RevertingPlugAtMultipleIndexes() public {
        for (uint8 testIndex = 0; testIndex < 5; testIndex++) {
            ...
            PlugTypesLib.Plug[] memory plugsArray =
                new PlugTypesLib.Plug[](testIndex + 2);
    ...
    //     assertEq(
    //         socketBalance,
    //         990_000_000_000_000_000_000,
    //         "Socket balance incorrect"
    //     );
    //
    ...
    //     uint256 dexBalance = mockERC20.balanceOf(address(dex));
    //     assertEq(
    //         dexBalance, 990_000_000_000_000_000_000, "DEX balance incorrect"
    //     );
    // }
    //
    ...
    //     bytes memory getStringCallData = abi.encodeWithSelector(
    //         mockDynamicData.returnString.selector, testString
    //     );
    //
    ...
    //     bytes memory getBytesCallData = abi.encodeWithSelector(
    //         mockDynamicData.returnBytes.selector, testBytes
    //     );
    //
    ...
    //     bytes memory getStructCallData = abi.encodeWithSelector(
    //         mockDynamicData.returnStruct.selector, id, name, arrayLength
    //     );
    //
    ...
    //     bytes memory getArray1CallData = abi.encodeWithSelector(
    //         mockDynamicData.returnUintArray.selector, uint256(3)
    //     );
    //
    ...
    //     bytes memory getArray2CallData = abi.encodeWithSelector(
    //         mockDynamicData.returnUintArray.selector, uint256(2)
    //     );
    //
    ...
    //     PlugTypesLib.Update[] memory processUpdates =
    //         new PlugTypesLib.Update[](1);
